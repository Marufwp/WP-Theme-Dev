...
function custom_breadcrumbs() {
    ...
    $breadcrums_class   = 'nav-breadcrumb breadcrumbs';
    $home_title         = '<i class="fa fa-home"></i> HOME';
      
    // If you have any custom post types with custom taxonomies, put the taxonomy name below (e.g. product_cat)
    $custom_taxonomy    = 'service-cat';
    ...
    if ( !is_front_page() ) {
        ...
        // Home page
        echo '<li class="item-home"><a class="bread-link bread-home" href="' . get_home_url() . '" title="Home">' . $home_title . '</a></li>';

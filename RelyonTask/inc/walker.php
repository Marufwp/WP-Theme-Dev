...
class Sunset_Walker_Nav_Primary extends Walker_Nav_menu
{
    ...
    { //ul
        ...
        $submenu = ($depth > 0) ? ' sub-menu' : 'current dropdown dropdown has-mega-menu';
    ...
    { //li a span
        ...
        $classes[] = ($item->current || $item->current_item_ancestor) ? 'current' : '';
        ...
        $attributes .= ($args->walker->has_children) ? ' class=""' : '';
